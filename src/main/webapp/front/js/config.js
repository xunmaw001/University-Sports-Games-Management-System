...
var indexNav = [
    ...
    {
        name: '工作安排信息',
        url: './pages/gongzuoanpai/list.html'
    },
    {
        name: '开闭幕式信息',
        url: './pages/kaibi/list.html'
    },
    {
        name: '赛事编排信息',
        url: './pages/saishibianpai/list.html'
    },
    {
        name: '学生项目',
        url: './pages/xueshengxiangmu/list.html'
    },

]

var adminurl =  "http://localhost:8080/yundonghui/admin/dist/index.html#/login";
