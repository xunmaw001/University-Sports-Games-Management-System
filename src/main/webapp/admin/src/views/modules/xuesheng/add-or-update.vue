<template>
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='yuanxi'">
                    <el-form-item class="select" v-if="type!='info'"  label="院系" prop="yuanxiId">
                        <el-select v-model="ruleForm.yuanxiId" :disabled="ro.yuanxiId" filterable placeholder="请选择院系" @change="yuanxiChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='yuanxi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="院系名称" prop="yuanxiName">
                        <el-input v-model="yuanxiForm.yuanxiName"
                                  placeholder="院系名称" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="院系名称" prop="yuanxiName">
                            <el-input v-model="ruleForm.yuanxiName"
                                      placeholder="院系名称" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='yuanxi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="院系总分" prop="yuanxiDefen">
                        <el-input v-model="yuanxiForm.yuanxiDefen"
                                  placeholder="院系总分" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="院系总分" prop="yuanxiDefen">
                            <el-input v-model="ruleForm.yuanxiDefen"
                                      placeholder="院系总分" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
            ...
            <input id="yuanxiId" name="yuanxiId" type="hidden">
               <el-col :span="12">
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.yuanxiChange(data.data.yuanxiId)
                    } else {
