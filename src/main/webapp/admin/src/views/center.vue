<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='caipan'"  label='裁判姓名' prop="caipanName">
               <el-input v-model="ruleForm.caipanName"  placeholder='裁判姓名' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='caipan'"  label='裁判手机号' prop="caipanPhone">
               <el-input v-model="ruleForm.caipanPhone"  placeholder='裁判手机号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='caipan'"  label='裁判身份证号' prop="caipanIdNumber">
               <el-input v-model="ruleForm.caipanIdNumber"  placeholder='裁判身份证号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
             <el-form-item v-if="flag=='caipan'" label='裁判头像' prop="caipanPhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='caipan'"  label='电子邮箱' prop="caipanEmail">
               <el-input v-model="ruleForm.caipanEmail"  placeholder='电子邮箱' clearable></el-input>
           </el-form-item>
         </el-col>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='xuesheng'" label='院系名称' prop="yuanxiName">
                 <el-input v-model="ruleForm.yuanxiName" :disabled="true" placeholder="院系名称"></el-input>
             </el-form-item>
         </el-col>
         <el-col :span="12">
             <el-form-item v-if="flag=='xuesheng'" label='院系总分' prop="yuanxiDefen">
                 <el-input v-model="ruleForm.yuanxiDefen" :disabled="true" placeholder="院系总分"></el-input>
             </el-form-item>
         </el-col>
         <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
                         if((!this.ruleForm.caipanName)&& 'caipan'==this.flag){
                             this.$message.error('裁判姓名不能为空');
                             return
                         }

                             if( 'caipan' ==this.flag && this.ruleForm.caipanPhone&&(!isMobile(this.ruleForm.caipanPhone))){
                                 this.$message.error(`手机应输入手机格式`);
                                 return
                             }
                         if((!this.ruleForm.caipanIdNumber)&& 'caipan'==this.flag){
                             this.$message.error('裁判身份证号不能为空');
                             return
                         }

                         if((!this.ruleForm.caipanPhoto)&& 'caipan'==this.flag){
                             this.$message.error('裁判头像不能为空');
                             return
                         }

                             if( 'caipan' ==this.flag && this.ruleForm.caipanEmail&&(!isEmail(this.ruleForm.caipanEmail))){
                         ...
                         if((!this.ruleForm.yuanxiId)&& 'xuesheng'==this.flag){
