    ...
    <div>
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">高校运动会管理系统注册</h1>
                <el-form class="rgs-form" label-width="120px">
                    ...
                    <el-form-item label="裁判姓名" class="input" v-if="tableName=='caipan'">
                        <el-input v-model="ruleForm.caipanName" autocomplete="off" placeholder="裁判姓名"  />
                    </el-form-item>
                    <el-form-item label="裁判手机号" class="input" v-if="tableName=='caipan'">
                        <el-input v-model="ruleForm.caipanPhone" autocomplete="off" placeholder="裁判手机号"  />
                    </el-form-item>
                    <el-form-item label="裁判身份证号" class="input" v-if="tableName=='caipan'">
                        <el-input v-model="ruleForm.caipanIdNumber" autocomplete="off" placeholder="裁判身份证号"  />
                    </el-form-item>
                    <el-form-item label="电子邮箱" class="input" v-if="tableName=='caipan'">
                        <el-input v-model="ruleForm.caipanEmail" autocomplete="off" placeholder="电子邮箱"  />
                    </el-form-item>
                    ...
                    <el-form-item class="select" v-if="tableName=='xuesheng'"   label="院系" prop="yuanxiId">
                        <el-select v-model="ruleForm.yuanxiId" style="width: 290px;" filterable placeholder="请选择院系" @change="yuanxiChange">
                            <el-option
                    ...
                    <el-form-item class="input" v-if="tableName=='xuesheng'"  label="院系名称" prop="yuanxiName">
                        <el-input v-model="yuanxiForm.yuanxiName"
                                  placeholder="院系名称" clearable readonly></el-input>
                    </el-form-item>
                    <!--<el-form-item class="input" v-if="tableName=='xuesheng'"  label="院系总分" prop="yuanxiDefen">
						<el-input v-model="yuanxiForm.yuanxiDefen"
								  placeholder="院系总分" clearable readonly></el-input>
					</el-form-item>-->
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                ...
                if('caipan' == this.tableName && this.ruleForm.caipanPhone&&(!this.$validate.isMobile(this.ruleForm.caipanPhone))){
                    this.$message.error('手机应输入手机格式');
                    return
                }
                if((!this.ruleForm.caipanIdNumber)&& 'caipan'==this.tableName){
                    this.$message.error('裁判身份证号不能为空');
                    return
                }
                if('caipan' == this.tableName && this.ruleForm.caipanEmail&&(!this.$validate.isEmail(this.ruleForm.caipanEmail))){
                ...
                if((!this.ruleForm.yuanxiId)&& 'xuesheng'==this.tableName){
